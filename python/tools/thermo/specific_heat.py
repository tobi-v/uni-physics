...
def SpecificHeat(T_H, T_K, T_M, m_W, m_K, C_D,
                 uncertainty=False, delT=0, delM=0, delC_D=0):
...
def CMeltIce(T_H, T_M, T_K, m_W, m_Ice, C_D,
             uncertainty=False, delT=0, delM=0, delC_D=0):
...
def CSteamCondensation(T_K, T_M, m_W, m_D, C_D,
                       uncertainty=False,
                       delT=0, delM=0, delC_D=0):
...
def CSteamCondensationElectric(voltage, current, t, m_D,
                               uncertainty=False, delU=0, delI=0, delt=0, delM=0):
