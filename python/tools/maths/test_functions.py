...
def test_symmetry():
    ...
    assert allclose(result[0], result[1]), "Gaussian should be symmetric around the mean"
...
def test_normalized_peak_value():
    ...
    expected = amp
    assert allclose(result, expected), "Peak of normalized Gaussian should match amplitude"
